...
test('renders a number input with a label "Favorite Number"', () => {
  ...
  // expect(div.querySelector('label')).toHaveTextContent('Favorite Number') // removed
})
...
/*
http://ws.kcd.im/?ws=react-testing-library-course&e=dom-testing-library&em=felixglush@gmail.com
*/
